...
[Documentation](../../packages.md) / [discloud.app](../README.md) / BaseSharedAppsManager

# Abstract Class: BaseSharedAppsManager\<T\>

Defined in: [packages/discloud.app/src/managers/BaseSharedAppsManager.ts:12](https://github.com/discloud/discloud.app/blob/c4016c90540db229b9170cffe6882c41b0b114cb/packages/discloud.app/src/managers/BaseSharedAppsManager.ts#L12)
...
`T` *extends* [`Instanciable`](../type-aliases/Instanciable.md)\<*typeof* [`BaseSharedApp`](BaseSharedApp.md)\>

## Constructors

### Constructor

> **new BaseSharedAppsManager**\<`T`\>(`discloudApp`, `holds`): `BaseSharedAppsManager`\<`T`\>

Defined in: [packages/discloud.app/src/managers/BaseSharedAppsManager.ts:14](https://github.com/discloud/discloud.app/blob/c4016c90540db229b9170cffe6882c41b0b114cb/packages/discloud.app/src/managers/BaseSharedAppsManager.ts#L14)

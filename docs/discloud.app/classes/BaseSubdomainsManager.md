...
[Documentation](../../packages.md) / [discloud.app](../README.md) / BaseSubdomainsManager

# Abstract Class: BaseSubdomainsManager\<T\>

Defined in: [packages/discloud.app/src/managers/BaseSubdomainsManager.ts:12](https://github.com/discloud/discloud.app/blob/c4016c90540db229b9170cffe6882c41b0b114cb/packages/discloud.app/src/managers/BaseSubdomainsManager.ts#L12)
...
- [`SubdomainsManager`](SubdomainsManager.md)

## Type Parameters

### T

`T` *extends* [`Instanciable`](../type-aliases/Instanciable.md)\<*typeof* [`BaseSubdomain`](BaseSubdomain.md)\>

## Constructors

### Constructor

> **new BaseSubdomainsManager**\<`T`\>(`discloudApp`, `holds`): `BaseSubdomainsManager`\<`T`\>

Defined in: [packages/discloud.app/src/managers/BaseSubdomainsManager.ts:14](https://github.com/discloud/discloud.app/blob/c4016c90540db229b9170cffe6882c41b0b114cb/packages/discloud.app/src/managers/BaseSubdomainsManager.ts#L14)
